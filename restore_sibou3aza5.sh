...
# SIBOU3AZA5 - System Restoration Script
...
echo -e "${PURPLE}================================${NC}"
echo -e "${PURPLE}   SIBOU3AZA5 SYSTEM RESTORE${NC}"
...
# SIBOU3AZA5 Postfix Configuration
myhostname = $DOMAIN
mydomain = $DOMAIN
...
create_config() {
    echo -e "${YELLOW}Creating SIBOU3AZA5 configuration...${NC}"
    
    cat > sibou3aza.conf <<CONF
# SIBOU3AZA5 Configuration File
DOMAIN="$DOMAIN"
...
main() {
    echo -e "${BLUE}SIBOU3AZA5 will restore your bulk email system${NC}"
    ...
    # Final instructions
    echo -e "${GREEN}================================${NC}"
    echo -e "${GREEN}   SIBOU3AZA5 RESTORATION COMPLETE${NC}"
    echo -e "${GREEN}================================${NC}"
    echo ""
